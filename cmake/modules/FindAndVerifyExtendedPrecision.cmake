...
if (${PROJECT_NAME}_ENABLE_MPC)
  if (NOT EL_HAVE_MPI_LONG_LONG)
    ...
    if (MPC_FOUND)
      set(${PROJECT_NAME}_HAVE_GMP TRUE)
      set(${PROJECT_NAME}_HAVE_MPFR TRUE)
      set(${PROJECT_NAME}_HAVE_MPC TRUE)
      list(APPEND EXTENDED_PRECISION_LIBRARIES "${MPC_LIBRARIES}")
    else ()
      message(WARNING "MPC requested but not found. Disabling.")
      set(${PROJECT_NAME}_HAVE_GMP FALSE)
      set(${PROJECT_NAME}_HAVE_MPFR FALSE)
      set(${PROJECT_NAME}_HAVE_MPC FALSE)
    endif (MPC_FOUND)
