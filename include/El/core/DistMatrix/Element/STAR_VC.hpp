...
public:
    ...
    typedef DistMatrix<Ring,STAR,VC,ELEMENT,Dev> type;
    typedef DistMatrix<Ring,VC,STAR,ELEMENT,Dev> transType;
    typedef DistMatrix<Ring,VC,STAR,ELEMENT,Dev> diagType;
