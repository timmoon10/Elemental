...
class DistMatrix<Ring,MC,STAR,ELEMENT,Dev>
...
public:
    ...
    using type = DistMatrix<Ring,MC,STAR,ELEMENT,Dev>;
    using transType = DistMatrix<Ring,STAR,MC,ELEMENT,Dev>;
    ...
    DistMatrix(DistMatrix<Ring,MC,STAR,ELEMENT,Dev2> const& A);
    ...
    template <Device Dev2,typename=typename std::enable_if<(Dev!=Dev2)&&(IsDeviceValidType<Ring,Dev>::value)&&(IsDeviceValidType<Ring,Dev2>::value)>::type>
    type& operator=(DistMatrix<Ring,MC,STAR,ELEMENT,Dev2> const& A);
