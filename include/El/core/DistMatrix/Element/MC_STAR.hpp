...
public:
    ...
    typedef DistMatrix<Ring,MC,STAR,ELEMENT,Dev> type;
    typedef DistMatrix<Ring,STAR,MC,ELEMENT,Dev> transType;
    typedef DistMatrix<Ring,MC,STAR,ELEMENT,Dev> diagType;
