...
public:
    ...
    using type = DistMatrix<Ring,CIRC,CIRC,ELEMENT,Dev>;
    using transType = DistMatrix<Ring,CIRC,CIRC,ELEMENT,Dev>;
    using diagType = DistMatrix<Ring,CIRC,CIRC,ELEMENT,Dev>;
    ...
    DistMatrix(DistMatrix<Ring,CIRC,CIRC,ELEMENT,Dev2> const& A);
    ...
    template <Device Dev2,typename=EnableIf<And<Not<SameDevice<Dev,Dev2>>,
                                                IsDeviceValidType<Ring,Dev>,
                                                IsDeviceValidType<Ring,Dev2>>>>
    type& operator=(DistMatrix<Ring,CIRC,CIRC,ELEMENT,Dev2> const& A);
