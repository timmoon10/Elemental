...
public:
    ...
    using type = DistMatrix<Ring,STAR,MR,ELEMENT,Dev>;
    using transType = DistMatrix<Ring,MR,STAR,ELEMENT,Dev>;
    ...
    DistMatrix(DistMatrix<Ring,STAR,MR,ELEMENT,Dev2> const& A);
    ...
    template <Device Dev2,typename=EnableIf<And<Not<SameDevice<Dev,Dev2>>,
                                                IsDeviceValidType<Ring,Dev>,
                                                IsDeviceValidType<Ring,Dev2>>>>
    type& operator=(DistMatrix<Ring,STAR,MR,ELEMENT,Dev2> const& A);
