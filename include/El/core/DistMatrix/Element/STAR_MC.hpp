...
class DistMatrix<Ring,STAR,MC,ELEMENT,Dev>
...
public:
    ...
    using type = DistMatrix<Ring,STAR,MC,ELEMENT,Dev>;
    using transType = DistMatrix<Ring,MC,STAR,ELEMENT,Dev>;
    using diagType = DistMatrix<Ring,MC,STAR,ELEMENT,Dev>;
    ...
    DistMatrix(DistMatrix<Ring,STAR,MC,ELEMENT,Dev2> const& A);
    ...
    template <Device Dev2,typename=EnableIf<And<Not<SameDevice<Dev,Dev2>>,
                                                IsDeviceValidType<Ring,Dev>,
                                                IsDeviceValidType<Ring,Dev2>>>>
    type& operator=(DistMatrix<Ring,STAR,MC,ELEMENT,Dev2> const& A);
