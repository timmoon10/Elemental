...
public:
    ...
    using type = DistMatrix<Ring,STAR,STAR,ELEMENT,Dev>;
    using transType = DistMatrix<Ring,STAR,STAR,ELEMENT,Dev>;
    using diagType = DistMatrix<Ring,STAR,STAR,ELEMENT,Dev>;
    ...
    DistMatrix(DistMatrix<Ring,STAR,STAR,ELEMENT,Dev2> const& A);
    ...
    template <Device Dev2,typename=typename std::enable_if<Dev!=Dev2>::type>
    type& operator=(DistMatrix<Ring,STAR,STAR,ELEMENT,Dev2> const& A);
