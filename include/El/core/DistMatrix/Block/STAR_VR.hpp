...
class DistMatrix<Ring,STAR,VR,BLOCK,Dev>
    : public BlockMatrix<Ring>
{
public:
    typedef AbstractDistMatrix<Ring> absType;
    typedef BlockMatrix<Ring> blockType;
    typedef DistMatrix<Ring,STAR,VR,BLOCK,Dev> type;
    typedef DistMatrix<Ring,VR,STAR,BLOCK,Dev> transType;
    typedef DistMatrix<Ring,VR,STAR,BLOCK,Dev> diagType;
