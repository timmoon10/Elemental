...
class DistMatrix<Ring,STAR,MR,BLOCK,Dev>
    : public BlockMatrix<Ring>
{
public:
    using absType = AbstractDistMatrix<Ring>;
    using blockType = BlockMatrix<Ring>;
    using type = DistMatrix<Ring,STAR,MR,BLOCK,Dev>;
    using transType = DistMatrix<Ring,MR,STAR,BLOCK,Dev>;
    using diagType = DistMatrix<Ring,MR,STAR,BLOCK,Dev>;
