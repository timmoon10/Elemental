...
class DistMatrix<Ring,STAR,STAR,BLOCK,Dev>
...
public:
    ...
    typedef DistMatrix<Ring,STAR,STAR,BLOCK,Dev> type;
    typedef DistMatrix<Ring,STAR,STAR,BLOCK,Dev> transType;
    typedef DistMatrix<Ring,STAR,STAR,BLOCK,Dev> diagType;
