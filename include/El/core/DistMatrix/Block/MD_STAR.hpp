...
class DistMatrix<Ring,MD,STAR,BLOCK,Dev>
    : public BlockMatrix<Ring>
{
public:
    typedef AbstractDistMatrix<Ring> absType;
    typedef BlockMatrix<Ring> blockType;
    typedef DistMatrix<Ring,MD,STAR,BLOCK,Dev> type;
    typedef DistMatrix<Ring,STAR,MD,BLOCK,Dev> transType;
    typedef DistMatrix<Ring,MD,STAR,BLOCK,Dev> diagType;
