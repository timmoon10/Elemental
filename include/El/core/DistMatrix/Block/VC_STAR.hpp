...
class DistMatrix<Ring,VC,STAR,BLOCK,Dev>
    : public BlockMatrix<Ring>
{
public:
    using absType = AbstractDistMatrix<Ring>;
    using blockType = BlockMatrix<Ring>;
    using type = DistMatrix<Ring,VC,STAR,BLOCK,Dev>;
    using transType = DistMatrix<Ring,STAR,VC,BLOCK,Dev>;
    using diagType = DistMatrix<Ring,VC,STAR,BLOCK,Dev>;
