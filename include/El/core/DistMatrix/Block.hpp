...
void AssertConforming1x2(
    const BlockMatrix<Ring>& AL, const BlockMatrix<Ring>& AR);

template<typename Ring>
void AssertConforming2x1(
    const BlockMatrix<Ring>& AT, const BlockMatrix<Ring>& AB);

template<typename Ring>
void AssertConforming2x2(
    const BlockMatrix<Ring>& ATL, const BlockMatrix<Ring>& ATR,
    const BlockMatrix<Ring>& ABL, const BlockMatrix<Ring>& ABR);
