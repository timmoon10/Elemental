...
// =============
template <typename T, Device D>
mpi::Comm BDM::DistComm() const EL_NO_EXCEPT { return Grid().VCComm(); }
...
template <typename T, Device D>
mpi::Comm BDM::ColComm() const EL_NO_EXCEPT { return Grid().MCComm(); }
template <typename T, Device D>
mpi::Comm BDM::RowComm() const EL_NO_EXCEPT { return Grid().MRComm(); }
...
template <typename T, Device D>
int BDM::ColStride() const EL_NO_EXCEPT { return Grid().MCSize(); }
template <typename T, Device D>
int BDM::RowStride() const EL_NO_EXCEPT { return Grid().MRSize(); }
template <typename T, Device D>
int BDM::DistSize() const EL_NO_EXCEPT { return Grid().VCSize(); }
template <typename T, Device D>
...
template <typename T, Device D>
int BDM::ColRank() const EL_NO_EXCEPT { return Grid().MCRank(); }
template <typename T, Device D>
int BDM::RowRank() const EL_NO_EXCEPT { return Grid().MRRank(); }
template <typename T, Device D>
int BDM::DistRank() const EL_NO_EXCEPT { return Grid().VCRank(); }
template <typename T, Device D>
