...
BDM& BDM::operator=( const DistMatrix<T,MR,STAR,BLOCK,D>& A )
{
    ...
    DistMatrix<T,VC,STAR,BLOCK,D> A_VC_STAR( this->Grid() );
...
BDM& BDM::operator=( const DistMatrix<T,STAR,MC,BLOCK,D>& A )
{
    ...
    DistMatrix<T,STAR,VR,BLOCK,D> A_STAR_VR( this->Grid() );
...
// =============
template <typename T, Device D>
mpi::Comm BDM::DistComm() const EL_NO_EXCEPT { return this->Grid().VCComm(); }
...
template <typename T, Device D>
mpi::Comm BDM::ColComm() const EL_NO_EXCEPT { return this->Grid().MCComm(); }
template <typename T, Device D>
mpi::Comm BDM::RowComm() const EL_NO_EXCEPT { return this->Grid().MRComm(); }
...
template <typename T, Device D>
int BDM::ColStride() const EL_NO_EXCEPT { return this->Grid().MCSize(); }
template <typename T, Device D>
int BDM::RowStride() const EL_NO_EXCEPT { return this->Grid().MRSize(); }
template <typename T, Device D>
int BDM::DistSize() const EL_NO_EXCEPT { return this->Grid().VCSize(); }
template <typename T, Device D>
...
template <typename T, Device D>
int BDM::ColRank() const EL_NO_EXCEPT { return this->Grid().MCRank(); }
template <typename T, Device D>
int BDM::RowRank() const EL_NO_EXCEPT { return this->Grid().MRRank(); }
template <typename T, Device D>
int BDM::DistRank() const EL_NO_EXCEPT { return this->Grid().VCRank(); }
template <typename T, Device D>
